...
static void gfx_device_init_(GFXDevice_* dev, VkPhysicalDevice device)
{
	...
	dev->base = (GFXDevice){
		...
		.limits = {
			...
			.maxPerStageUniformBuffers   = pdp->limits.maxPerStageDescriptorUniformBuffers,
			.maxPerStageStorageBuffers   = pdp->limits.maxPerStageDescriptorStorageBuffers,
			.maxPerStageSampledImages    = pdp->limits.maxPerStageDescriptorSampledImages,
			.maxPerStageStorageImages    = pdp->limits.maxPerStageDescriptorStorageImages,
			.maxPerStageSamplers         = pdp->limits.maxPerStageDescriptorSamplers,
			.maxPerStageAttachmentInputs = pdp->limits.maxPerStageDescriptorInputAttachments,

			.maxBoundSets                  = pdp->limits.maxBoundDescriptorSets,
			.maxBoundUniformBuffers        = pdp->limits.maxDescriptorSetUniformBuffers,
			.maxBoundStorageBuffers        = pdp->limits.maxDescriptorSetStorageBuffers,
			.maxBoundUniformBuffersDynamic = pdp->limits.maxDescriptorSetUniformBuffersDynamic,
			.maxBoundStorageBuffersDynamic = pdp->limits.maxDescriptorSetStorageBuffersDynamic,
			.maxBoundSampledImages         = pdp->limits.maxDescriptorSetSampledImages,
			.maxBoundStorageImages         = pdp->limits.maxDescriptorSetStorageImages,
			.maxBoundSamplers              = pdp->limits.maxDescriptorSetSamplers,
			.maxBoundAttachmentInputs      = pdp->limits.maxDescriptorSetInputAttachments,

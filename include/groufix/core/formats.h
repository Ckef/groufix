...
typedef enum GFXFormatFeatures
{
	...
	GFX_FORMAT_STORAGE_IMAGE        = 0x0020,
	GFX_FORMAT_ATTACHMENT           = 0x0040,
	GFX_FORMAT_ATTACHMENT_BLEND     = 0x0080,
	GFX_FORMAT_IMAGE_READ           = 0x0100,
	GFX_FORMAT_IMAGE_WRITE          = 0x0200,
